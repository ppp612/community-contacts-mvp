...
const translations = {
  ...
  zh: {
    badge: "社区更新",
    title: "保持联系，也告诉我们您关心的社区问题",
    subtitle: "留下联系方式，接收蔡市长的社区更新，也可以分享本地问题或请求团队跟进。",
    detailsTitle: "您的联系方式",
    ...
    localConcernTitle: "有什么想让我们了解的吗？",
    localConcernHelp: "您可以分享本地问题、具体地点，或希望团队了解的建议。",
    mainConcern: "主要关心的问题",
  ...
  ko: {
    badge: "커뮤니티 소식",
    title: "계속 소식을 받고 지역에서 중요한 일을 알려 주세요",
    subtitle: "차이 시장의 커뮤니티 소식을 받고, 지역 관심 사항을 공유하거나 후속 연락을 요청하실 수 있습니다.",
    detailsTitle: "연락처 정보",
    ...
    localConcernTitle: "저희가 무엇을 알면 좋을까요?",
    localConcernHelp: "팀에서 이해했으면 하는 지역 문제, 장소 또는 의견을 공유해 주세요.",
  ...
  vi: {
    ...
    title: "Giữ kết nối và chia sẻ điều quan trọng tại địa phương",
    subtitle:
      "Để lại thông tin để nhận cập nhật cộng đồng từ Thị trưởng Cai, chia sẻ mối quan tâm địa phương hoặc yêu cầu nhóm theo dõi.",
    ...
    localConcernTitle: "Bạn muốn chúng tôi biết điều gì?",
    localConcernHelp: "Chia sẻ vấn đề, địa điểm hoặc ý kiến địa phương mà bạn muốn nhóm hiểu rõ hơn.",
